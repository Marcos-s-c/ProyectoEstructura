...
public class EcuacionLineal {
    ...
    public static void main(String[] args) {
        ...
        // Se recolectan los valores para las variables y se preguntan si es un número irreal o una letra inválida
    ...
    // Calcula el valor de y para un valor de x dado, usando la pendiente (m) y la ordenada al origen (b)
    public static double calcularY(double x, double pendiente, double ordenadaAlOrigen) {
